...
expName = 'adaptive staircase procedure '  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/tiaragajjar/Desktop/adaptive staircase procedure _lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStair in stair:
        ...
        # Run 'Begin Routine' code from fifityfifty
        ...
        # Run 'End Routine' code from fifityfifty
