...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/tiaragajjar/Desktop/lab/stroop task /stroop_task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        if ins.forceEnded or routineForceEnded:
            break
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/tiaragajjar/Downloads/stroop practice.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['b','r'], ignoreKeys=["escape"], waitRelease=False)
    ...
    # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
    if ty.maxDurationReached:
        routineTimer.addTime(-ty.maxDuration)
    elif ty.forceEnded:
        routineTimer.reset()
    else:
        routineTimer.addTime(-1.000000)
