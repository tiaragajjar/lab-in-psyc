...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/tiaragajjar/Desktop/lab/EXP4 visual search/Visual Search Experiment_lastrun.py',
    ...
    for thisTrial in trials:
        ...
        for i in range(num_distr):
            ...
            distr = visual.TextStim(win=win, name='distr',
                text='L',
                font='Open Sans',
                pos=(random()-0.5, random()-0.5), height=0.05, wrapWidth=None, ori=randint(1,360), 
                color='white', colorSpace='rgb', opacity=None, 
                languageStyle='LTR',
                depth=-2.0);
