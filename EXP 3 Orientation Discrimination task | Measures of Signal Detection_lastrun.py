...
expName = 'EXP 3 Orientation Discrimination task | Measures of Signal Detection'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/tiaragajjar/Desktop/EXP 3 Orientation Discrimination task | Measures of Signal Detection_lastrun.py',
