...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/tiaragajjar/Desktop/lab/EXP4 visual search/Visual Search Experiment.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    target = visual.TextStim(win=win, name='target',
        text='T',
        font='Arial',
        pos=(random()-0.5, random()-0.5), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
